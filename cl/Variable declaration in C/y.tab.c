...
{
  "$end", "error", "$undefined", "DT", "ID", "VAL", "COM", "SEM", "EQU",
  "NL", "$accept", "stmt", "S", "A", "B", YY_NULLPTR
};
#endif
...
{
       9,     1,    10,     4,     7,     8,    13,    11,    12,     9,
      15,    17,    16,    18,     0,     0,    10,     0,    14
};
